	...
	return (
		<>
			...
			<Grid container justify='space-between' className={classes.buttonsGrid}>
				<Button variant='contained' className={classes.blueButton} size='small' onClick={() => setOpenDialog(true)}>
					New meeting
				</Button>
				<Button variant='contained' className={classes.whiteButton} size='small' onClick={() => setOpenDialog(true)}>
					Join with code
				</Button>
			</Grid>
			<Grid container className={classes.imageGrid} direction='column' alignItems='center' spacing={3}>
				<img src={MeetingImage} alt='Meeting' className={classes.meetingImage} />
